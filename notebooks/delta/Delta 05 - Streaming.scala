...
// MAGIC 
// MAGIC ## CAUTION
// MAGIC * Streaming jobs will quickly exhaust your disk quota, if you are using Community Edition. If you find yourself running out of disk space, 
// MAGIC   you can [mount your own S3 bucket](https://docs.databricks.com/spark/latest/data-sources/aws/amazon-s3.html#mount-an-s3-bucket) and change
// MAGIC   your streaming paths accordingly.
